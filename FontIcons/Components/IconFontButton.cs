...
namespace FontIcons
{
    ...
    public class IconFontButton : Button
    {
        ...
        public static readonly BindableProperty IconFontProperty = BindableProperty.Create<IconFontButton, Object> (
                                                                           p => p.IconFont,
                                                                       null,
                                                                       propertyChanged: (bindable,
                                                                       oldValue,
                                                                       newValue) => ((IconFontButton)bindable).SetIconFontText (newValue)
                                                                   );
